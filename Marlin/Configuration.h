...
#define STRING_CONFIG_H_AUTHOR "(mmark, Ender-3)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 34.62
  #define DEFAULT_bedKi 2.67
  #define DEFAULT_bedKd 299.78
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 42, 13, -0.9 }
...
#define Y_MIN_POS -30
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE // 229 //Physical stop is at 254
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.28   // (mm) Default layer height for G26.
  ...
  #define MESH_INSET 24            // Set Mesh bounds as an inset region of the bed
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 60 // X point for Z homing  X_CENTER
  #define Z_SAFE_HOMING_Y_POINT 60 // Y point for Z homing  Y_CENTER
#endif
